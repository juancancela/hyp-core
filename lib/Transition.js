 ...
 * @param finalState final state of the transition. Can be a final state value, or a function, for cases of dynamic
 *        states.
 ...
 */
Transition.prototype.getInitialState = function (machine) {
    if(typeof this._initialState == "function") return this._initialState(machine);
 ...
 * @returns {*} the initial state of the transition
 */
Transition.prototype.getFinalState = function (machine) {
    if(typeof this._finalState == "function") return this._finalState(machine);
