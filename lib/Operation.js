 ...
 * @param finalState the final state to which machine transitions in case of operation was successfully executed
 * @returns {*}
 */
Operation.prototype.execute = function (machine, parameters, finalState, cb) {
    if (!machine) throw new Error("Error: Machine where operation would be executed is not defined");
    return this._implementation(machine, parameters, finalState, cb);
};
